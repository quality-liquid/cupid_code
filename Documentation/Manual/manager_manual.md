...
The Cupid Code Manager Manual is a guide for managers who are using the Cupid Code system. 
This manual will provide information on how to sign up, log in, and navigate the site as a Manager.
...
For Managers there is no signing up process. 
You will need to work with the system administrator to get your account created.
...
Enter the email given by the System Administrator
...
This page has all the Daters listed with the ability to suspend or unsuspend them.
...
### Cupids
This page has all the Cupids listed with the ability to suspend or unsuspend them, and works the same as the Dater Information Page.
