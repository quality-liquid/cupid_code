...
urlpatterns = [
    ...
    path('dater/create_date/', views.create_date, name='create_date'),
    ...
    path('dater/payment/<int:pk>/', views.get_payment, name='get_payment'),
    ...
    path('cupid/transfer/', views.transfer_out, name='cupid_transfer'),
    ...
    path(
        'cupid/create_stripe_account/',
        views.create_stripe_account, 
        name='create_stripe_account'
    ),
    path(
        'cupid/create_onboarding_link/', 
        views.create_onboarding_link, 
