...
<template>
	<div class="notification-center-root">
		...
		<div class="send-box">
			...
			<p style="font-size: 0.85rem; color: #666;">Create a browser notification that appears immediately.</p>
...
.send-box input, .send-box textarea { width:100%; padding:.5rem; border:1px solid #ccc; border-radius:4px; font:inherit; }
...
.list li { background:#fafafa; border:1px solid #e1e1e1; padding:.6rem .75rem; border-radius:6px; box-shadow:0 1px 2px rgba(0,0,0,.05); }
