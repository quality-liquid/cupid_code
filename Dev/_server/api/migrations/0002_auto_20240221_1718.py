...
@transaction.atomic
def dummy_feedbacks(owners, gigs, Feedback):
    """
...
def main(apps, schema_editor):
    ...
    # Feedback
    dummy_feedbacks((cupid1.user, cupid2.user, dater1.user), gigs, Feedback)
