...
urlpatterns = [
    ...
    path('chat/<int:id>/', views.get_five_messages, name='get_five_messages'),
    path('dater/calendar/<int:id>/', views.calendar, name='calendar'),
    path('dater/rate/', views.rate_dater, name='rate_dater'),
    path('dater/ratings/<int:id>/', views.get_dater_ratings, name='get_dater_ratings'),
    path('dater/avg_rating/<int:id>/', views.get_dater_avg_rating, name='get_dater_avg_rating'),
    path('dater/transfer/', views.dater_transfer, name='dater_transfer'),
    path('dater/balance/<int:id>/', views.get_dater_balance, name='get_dater_balance'),
    ...
    path('cupid/ratings/<int:id>/', views.get_cupid_ratings, name='get_cupid_ratings'),
    path('cupid/avg_rating/<int:id>/', views.get_cupid_avg_rating, name='get_cupid_avg_rating'),
    path('cupid/transfer/', views.cupid_transfer, name='cupid_transfer'),
    path('cupid/balance/<int:id>/', views.get_cupid_balance, name='get_cupid_balance'),
    path('cupid/profile/<int:id>/', views.get_cupid_profile, name='get_cupid_profile'),
    ...
    path('geo/stores/', views.get_stores, name='get_stores'),
    path('geo/activities/', views.get_activities, name='get_activities'),
    path('geo/events/', views.get_events, name='get_events'),
    path('geo/attractions/', views.get_attractions, name='get_attractions'),
    path('geo/user/<int:id>/', views.get_user_location, name='get_user_location'),
